...
parser.add_argument('--data_dir', type=str, default='F:/AppData/PycharmProjects/DeepLearning/models-master/models-master/official/resnet/tmp/cifar10_data',
                    help='The path to the CIFAR-10 data directory.')

parser.add_argument('--model_dir', type=str, default='F:/AppData/PycharmProjects/DeepLearning/models-master/models-master/official/resnet/tmp/cifar10_model',
